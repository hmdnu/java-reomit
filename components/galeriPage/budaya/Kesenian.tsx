...
export default function Kesenian() {
  return (
    <div className="relative columns-2 sm:columns-2 md:columns-3 gap-5 sm:gap-8">
      {gallery.kesenian?.map((kesenian, i) => (
        <div key={i}>
          <div className="group relative">
            <Image src={kesenian.img} alt={kesenian.altImg} className="rounded-lg mb-5 sm:mb-8 w-auto h-auto" />
            <Link
              href={`/galeri/kesenian/${kesenian.altImg}`}
