          ...
          >
            ...
            <div>
              <div className="px-[30px] py-[20px]">
                <h1 className="font-bold text-h5 md:text-h3 text-white">{article.title}</h1>
              </div>
              <div className="px-[30px] pb-[30px]">
                <div className="text-fontSecondary flex gap-3 items-center text-h7 md:text-h5 font-medium">
                  <h2>{article.creator}</h2> <div className="bg-fontSecondary w-[6px] h-[6px] rounded-full"></div>
                  <h1>{article.dateCreated}</h1>
                </div>

                <h1 className="font-medium text-h7 md:text-h5 text-themeRed">
