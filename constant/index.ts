...
export const articleCards: ArticleCardTypes[] = [
  ...
  },
  {
    ...
    contentPreview:"Upacara Kasada, atau juga dikenal sebagai Tenggerese Kasada, adalah perayaan sakral yang mendalam di kalangan suku Tengger, Jawa Timur. Upacara ini merupakan bentuk penghormatan kepada Sang Hyang Widhi, Tuhan menurut kepercayaan suku Tengger, serta merupakan perayaan tradisional yang kaya akan makna spiritual.",
    img: kasada,
    imgAlt: "kasada",
  },
  {
    ...
    contentPreview: "Tari Remo, sebuah warisan budaya Jawa yang kaya akan nilai-nilai tradisional, telah berhasil menarik perhatian dunia internasional atas keindahan geraknya yang elegan dan keunikan artistiknya. Dalam tari ini, gerakan yang lembut, tetapi kuat, memikat para penonton",
    img: tariRemo,
    imgAlt: "tari-remo",
  },
];
